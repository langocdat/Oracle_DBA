# Step 1: Tạo file dbca_mobiledb.rsp
- Đường dẫn: /u01/app/oracle/product/19.0.0.0/dbhome_1/assistants/dbca/dbca_mobiledb.rsp
- Nội dung:
```
...
```
# Step 2: Chạy lệnh thực thi file dbca_mobiledb.rsp
[oracle]$
```
/u01/app/oracle/product/19.0.0.0/dbhome_1/bin/dbca -silent -debug -createDatabase -responseFile /u01/app/oracle/product/19.0.0.0/dbhome_1/assistants/dbca/dbca_mobiledb.rsp
```
